...
from inventory.views import UploadExcelView, ProductListView, CategoryListView
...
urlpatterns = [
    ...
    path('api/upload-excel/', UploadExcelView.as_view(), name='upload_excel'),
    ...
    path("api/products/<int:pk>/delete/", delete_product, name="delete_product"),
]
